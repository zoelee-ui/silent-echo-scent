  ...
  return (
    <main className="min-h-screen bg-[#FDFDFD] flex items-center justify-center p-4 md:p-12 text-black select-none relative overflow-hidden font-sans" onMouseMove={handleMouseMove}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* ✅ 核心修正：不透明度增加 20% (從 0.15/0.25 調升至 0.35/0.45)，飽和度增加 20% (從 30%/45% 調升至 50%/65%) */
      ...
      {/* Navigation, Story Popup, VIP Dashboard, Quiz, Particle 邏輯維持原樣 (節略顯示以節省空間) */}
      {/* ... 包含原有的 nav, story modal, vip dashboard ... */}
      ...
      {/* 其餘 Quiz, Particle, Login 畫面... 為了保持完整性，請確保在你的專案中保留這些區塊 */}
    </main>
  );
}